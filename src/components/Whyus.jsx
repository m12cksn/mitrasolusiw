  ...
  const companies = [
    {
      ...
      desc: "Penyedia layanan kantor bersama yang telah memiliki banyak pelanggan, dan telah berpengalaman.",
    },
    {
      imgUrl: "/MSW/sertifikation.svg",
      title: "Tersertifikasi   ",
      desc: "Perusahaan telah memiliki sertifikasi ISO, yang akan menjamin pelayanan terbaik untuk para pelanggannya.",
    },
    {
      imgUrl: "/MSW/pajak.svg",
      title: "Telah berstatus PKP ",
      desc: "Perusahaan sebagai Pengelola Virtual Office telah berstatus Pengusaha Kena Pajak (PKP),sehingga memudahkan Anda dalam dalam mengurus PKP",
    },
    {
      imgUrl: "/MSW/pajak.svg",
            ...
            <div className="container w-full mt-5 max-w-xs xl:max-w-md  rounded-lg shadow ">
              <div className="flex flex-col items-center py-10">
                <img
                  ...
                  alt="Bonnie image"
                />
                <h5 className="text-center text-xl lg:text-2xl font-medium text-primary mb-3">
                  {company.title}
                </h5>
